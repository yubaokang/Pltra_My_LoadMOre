...
import in.srain.cube.views.ptr.demo.ui.classic.FooterFeatures;
...
import in.srain.cube.views.ptr.demo.ui.classic.RecyclerVIewTest;
...
import in.srain.cube.views.ptr.demo.ui.classic.WithGridViewInFrameLayout;
...
public class PtrDemoHomeFragment extends BlockMenuFragment {
    ...
    protected void addItemInfo(ArrayList<BlockMenuFragment.MenuItemInfo> itemInfos) {
        // RecyclerView
        itemInfos.add(newItemInfo(R.string.ptr_demo_block_recyclerview, R.color.cube_mints_4d90fe, new OnClickListener() {
